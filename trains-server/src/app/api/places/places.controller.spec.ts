...
describe('Places Controller', () => {
  ...
  describe('GET /places', () => {
    ...
    it('should return posts when logged in as normal user', async () => {
      const mockFind = spyOn(repository, 'find').and.returnValue(
  ...
  describe('GET /places/:id', () => {
    ...
    it('should return data when logged in as normal user', async () => {
      spyOn(repository, 'findOne').and.returnValue(Promise.resolve(PLACE1));
  ...
  describe('POST /places', () => {
    ...
    it('should create a new place', async () => {
      const mockCreate = spyOn(repository, 'create').and.returnValue(PLACE4);
      const mockSave = spyOn(repository, 'save').and.returnValue(
        Promise.resolve(PLACE4),
      );
